...
const Sidebar = () => {
    ...
    return (
        ...
        <div className={`${isCollapsed ? 'w-24' : 'w-64'} flex flex-col border border-fuchsia-700/60 bg-gradient-to-br from-purple-800/50 to-pink-800/40 py-8 text-neutral-300 shadow-xl rounded-xl ease-in-out duration-700`} >

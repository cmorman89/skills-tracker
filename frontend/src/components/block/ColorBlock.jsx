    ...
    >
      ...
      >
        <h1 className="font-semibold text-5xl mb-4 hover-float">
          Know what you{" "}
          <span className="italic font-semibold text-amber-300">know</span>.
        </h1>
        <p className="font-inter text-lg font-light">
          With SkillAtlas, you can easily track your skills and knowledge, and
      ...
      <div className="flex w-1/2 h-full items-baseline justify-end">
        <img
          src="brain.png"
          alt="brain"
          className="w-2/3 mr-1 mt-3 hover-float"
        />
      </div>
    </div>
  );
